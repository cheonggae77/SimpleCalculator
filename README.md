...
## 개요
- C# 프로그래밍 학습
- 1줄 소개: WINDOWS 계산기 같은 간단한 사칙연산 계산기를 만들어보는 과제.
- 사용한 플랫폼:
...
![과제4 실행화면](img/lec4_3.png)

- 과제 내용
1. 괄호를 키보드로 입력시 텍스트박스에 괄호가 입력되고 연산까지 가능하도록 구현
 ▶ 예시로 48/2(9+3)을 입력
2. 키보드를 통해 숫자와 연산자를 입력하는 기능 구현
- 구현 내용과 기능 설명
1. 키보드로 숫자 입력시 숫자가 입력되고 괄호 입력시 괄호가 자동으로 완성되도록 구현하였습니다. 예를 들어, ( 버튼을 클릭하면 TextBox에 ()가 입력되고 커서가 괄호 사이에 위치하도록 구현하였습니다.
 ▶ 괄호는 키보드로 입력하고 괄호가 자동으로 완성되도록 구현하였습니다. 예를 들어, ( 버튼을 클릭하면 TextBox에 ()가 입력되고 커서가 괄호 사이에 위치하도록 구현하였습니다.
2. 키보드를 눌러 숫자 및 연산자를 입력할 수 있도록 구현하였습니다. 예를 들어, 숫자 버튼과 연산자 버튼에 각각 Click 이벤트 핸들러를 추가하여 키보드 입력을 처리하도록 구현하였습니다. 또한, TextBox의 KeyPress 이벤트 핸들러를 추가하여 키보드 입력을 처리하도록 구현하였습니다. 예를 들어, 숫자 키와 연산자 키가 눌렸을 때 해당 값을 TextBox에 추가하는 방식으로 구현하였습니다.