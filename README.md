...
2. 결과값이 나온 후 다시 =을 누르면 마지막 연산과 피연산자를 이용하여 계산이 반복되도록 구현하였습니다. 예를 들어, 12 + 100 = 112 상태에서 = 버튼을 다시 클릭하면 112 + 100 = 212로 계산이 반복되도록 구현하였습니다.
3. esc 키를 누르면 프로그램이 종료되도록 구현하였습니다. 예를 들어, Form의 KeyDown 이벤트 핸들러에서 esc 키 입력을 감지하여 Application.Exit() 메서드를 호출하여 프로그램을 종료하는 방식으로 구현하였습니다.